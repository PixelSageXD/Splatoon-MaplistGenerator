...
# This is a random Python project I decided to make for my team (Star Shower) when I got tired of making random-seeming maplists using popular mapmodes.
# You don't need to know how this works but I have put comments throughout to explain how the program actually runs through everything.
